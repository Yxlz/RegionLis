...
public class DataScopeAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.rlis.common.annotation.DataScope)")
     ...
     */
    public static void dataScopeFilter(JoinPoint joinPoint, RlSysUser user, String orgAlias, String userAlias)
    {
        StringBuilder sqlString = new StringBuilder();

        for (RlSysRole role : user.getRoles())
        {
            ...
            else if (DATA_SCOPE_CUSTOM.equals(dataScope))
            {
                sqlString.append(StringUtils.format(
                        " OR {}.org_id IN ( SELECT org_id FROM rl_sys_role_org WHERE role_id = {} ) ", orgAlias,
                        role.getRoleId()));
            }
            ...
            {
                sqlString.append(StringUtils.format(
                        " OR {}.org_id IN ( SELECT org_id FROM rl_sys_org WHERE org_id = {} or find_in_set( {} , ancestors ) )",
