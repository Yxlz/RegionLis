...
public class SysDictTypeController extends BaseController
{
    ...
    @ResponseBody
    public TableDataInfo list(RlSysDictType dictType)
    {
        startPage();
        List<RlSysDictType> list = dictTypeService.selectDictTypeList(dictType);
    ...
    @PostMapping("/export")
    @ResponseBody
    public AjaxResult export(RlSysDictType dictType)
    {

        List<RlSysDictType> list = dictTypeService.selectDictTypeList(dictType);
        ExcelUtil<RlSysDictType> util = new ExcelUtil<RlSysDictType>(RlSysDictType.class);
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(@Validated RlSysDictType dict)
    {
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(@Validated RlSysDictType dict)
    {
        if (UserConstants.DICT_TYPE_NOT_UNIQUE.equals(dictTypeService.checkDictTypeUnique(dict)))
        {
    ...
    {
        List<Ztree> ztrees = dictTypeService.selectDictTree(new RlSysDictType());
        return ztrees;
    }
}
