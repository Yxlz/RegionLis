...
import com.rlis.common.annotation.Excel.ColumnType;
import com.rlis.common.annotation.Excel.Type;
...
/**
 * @ClassName: RlSysUser
 * @Description: 用户对象 rl_sys_user
 * @Author tangxiaohui
 * @Copyright: Copyright (c) 2020
 * @Company: 成都信通网易医疗科技发展有限公司
 * @DateTime 2020/7/10 13:33
 */
public class RlSysUser extends BaseEntity
{
    ...
    private List<com.rlis.system.domain.RlSysRole> roles;
    ...
    public List<RlSysRole> getRoles()
    {
        return roles;
    }

    public void setRoles(List<RlSysRole> roles)
    {
        this.roles = roles;
    }
