...
public class GenUtils
{
     ...
     * 初始化表信息
     */
    public static void initTable(RlGenTable genTable, String operName)
    {
     ...
     * 初始化列属性字段
     */
    public static void initColumnField(RlGenTableColumn column, RlGenTable table)
    {
